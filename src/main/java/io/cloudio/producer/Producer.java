...
public class Producer extends KafkaProducer<String, Data> implements TransactionProducer<String, Data> {
  ...
  public Future<RecordMetadata> send(String topicName, Data message) throws Exception {
  ...
  @Override
  public Future<RecordMetadata> send(String topicName, String key, Data message) throws Exception {
    if (firstSend) {
