...
public class Producer extends KafkaProducer<String, Record> implements TransactionProducer<String, Record> {
  ...
  public static Properties getProperties() {
    ...
    //  properties.put(ProducerConfig.PARTITIONER_CLASS_CONFIG, FlowPartitioner.class);

    return properties;
  }

  public static RecordMetadata sendMessage(String topicName, Record message) throws Exception {
    try (Producer p = get()) {
      p.beginTransaction();
  ...
  public static OffsetRange sendMessages(String topicName, List<Record> messages) throws Exception {
    try (Producer p = get()) {
      p.beginTransaction();
  ...
  public Future<RecordMetadata> send(String topicName, Record message) throws Exception {
  ...
  @Override
  public Future<RecordMetadata> send(String topicName, String key, Record message) throws Exception {
    if (firstSend) {
